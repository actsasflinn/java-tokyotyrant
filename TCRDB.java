...
public class TCRDB {
   ...
   */
  public native boolean tune(double timeout, int opts);
  /**
   ...
   * @return If successful, it is true, else, it is false.
   */
  public native boolean open(String host, int port);
  /**
   * Open a database file.
   * The same as `open(name, 1978)'.
   * @see #open(String, int)
   */
  public boolean open(String name){
    return open(name, 1978);
  }
  /**
